<template>
  <section class="flex w-full">
    <div class="m-auto">
      ...
      <div class="grid grid-cols-4 gap-1 bg-gray-200">
        <button
          @click="pressed('1')"
        ...
        <button @click="pressed('=')" class="p-2 h-10 border rounded shadow">
          =
        </button>
        <button
          @click="pressed('/')"
...
<script>
import { ref } from "vue";
import windowEvent from "../utilities/composition/windowEvent";
export default {
  setup() {
